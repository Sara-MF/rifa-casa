...
export default function Home() {
  ...
  return (
    <Card className="bg-cream flex flex-col justify-center items-center m-auto md:w-8/12 h-fit p-8 my-20 shadow-2xl">
        ...
        <div className="w-full flex flex-col md:flex-row justify-evenly">
          ...
          <Info title="Pagamento por Pix" content="sara.melo.smf@gmail.com" />
